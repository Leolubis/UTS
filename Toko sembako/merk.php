...
<body>
   ...
   <header>
    <div class="container">
    <h1><a href="index.php">RestoIzna</a></h1>
    <ul>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                if($_GET['search'] != '' || $_GET['kat'] != ''){
                    $where = "AND nama_merk LIKE '%".$_GET['search']."%' AND jenis_produk LIKE '%".$_GET['kat']."%' ";
                }
                    $produk = mysqli_query($conn, "SELECT * FROM merk WHERE status = 1 $where ORDER BY nama_merk DESC");
                    if(mysqli_num_rows($produk) > 0){
                        while($p = mysqli_fetch_array($produk)){
                ?>
                    <a href="detail-merk.php?id=<?php echo $p['produk_id'] ?>">
                        <div class="col-4">
   ...
   <div class="container">
    ...
    <small>Copyright &copy; 2023 - RestoIzna.</small>
   </div>
   </div>
</body>
</html>