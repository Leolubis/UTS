  ...
  <body class="hold-transition sidebar-mini">
        ...
        <div class="row">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <select class="input-control" name="kategori" required>
                    ...
                    <?php
                        $kategori = mysqli_query($conn, "SELECT * FROM produk ORDER BY nama DESC ");
                ...
                <select class="input-control" name="kategori" required>
                    ...
                    <?php
                        $kategori = mysqli_query($conn, "SELECT * FROM merk ORDER BY nama_merk DESC ");
                        while ($r = mysqli_fetch_array($kategori)) {
                    ?>
                    <option value="<?php echo $r['nama_merk'] ?>"><?php echo $r['nama_merk'] ?></option>
                    <?php } ?>
                </select>
                <input type="text" name="nama" placeholder="merk" class="input-control" required>
                <input type="text" name="harga" placeholder="stok" class="input-control" required>
    ...
    <!-- /.content-wrapper -->
      ...
      <footer class="main-footer bg-danger">
        ...
        <!-- Default to the left -->
        <p>Created with <i class="bi bi-heart-fill text-light"></i> by <a class="text-black fw-bold" href="https://api.whatsapp.com/send?phone=62812345678&text=udah liat semuanya, kerenn ">Me</a></p>
      </footer>
    </div>
    <!-- ./wrapper -->
